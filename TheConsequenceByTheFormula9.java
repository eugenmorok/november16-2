...
public class TheConsequenceByTheFormula9 {
...
деление с отбрасыванием остатка.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arrLen; i++) {
            ...
            elementForAdding = 2 << (n - 1);

            elementForAdding = 2 << (elementForAdding - 1);

            c = (double)(2 << (2 * n - 1));

            elementInDouble = (double)elementForAdding / c;

            //double f = (double)256 / (double)4096;
            //System.out.println("f   : " + f);
            //System.out.println("ed   : " + c);

            newArray[i] = (int) elementInDouble;
